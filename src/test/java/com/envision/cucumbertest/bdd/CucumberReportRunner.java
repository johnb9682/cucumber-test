...
/**
 * <P>Class to generate html report from cucumber runner's json report output.</P>
 * <p>CucumberReportRunner generates reports from the file at target/cucumber-report.json</p>
 * <p>CucumberReportRunner copies the generated html reports to target/classes/static directory so that the reports are packaged along with the application.</p>
 *
 * @author john.bi
 */
